    ...
    ! function(a) {
        ...
        k.VERSION = "1.12.1", k.DEFAULTS = {
            ...
            countSelectedText: function(a, b) {
                return 1 == a ? "{0} selecionado" : "{0} selecionados"
            },
            maxOptionsText: function(a, b) {
                return [1 == a ? "Limite de ({n} item max)" : "Limite atingido ({n} items max)", 1 == b ? "Limite de grupo atingido ({n} item máx)" : "Group limit reached ({n} itens máx)"]
            },
