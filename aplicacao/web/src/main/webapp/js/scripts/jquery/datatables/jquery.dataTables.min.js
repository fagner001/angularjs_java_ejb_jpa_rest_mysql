...
(function(h) {
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" placeholder="Buscar..." class="' + b.sFilterInput + '"/>',
            j = d.sSearch,
            ...
            i = h("input", b).val(e.sSearch).on("keyup.DT search.DT input.DT paste.DT cut.DT", g ? Qa(f, g) : f).on("keypress.DT", function(a) {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Mostrando _START_ de _END_ em _TOTAL_ resultados",
            sInfoEmpty: "Mostrando 0 de 0 em 0 resultados",
            sInfoFiltered: "(filtrando _MAX_ resultados)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
