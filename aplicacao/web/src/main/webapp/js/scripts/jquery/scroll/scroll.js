...
! function(t, e) {
    ...
    return function(t) {
            ...
            return (0, d.default)(t, [{
                ...
                value: function() {
                    ...
                    var r = this.contentEl[this.scrollSizeAttr[t]],
                        ...
                        s = o / r,
                        c = Math.round(s * i) + 2,
                        u = Math.floor(s * (o - 2)) - 2;
                    this.isVisible[t] = o < r, this.isVisible[t] ? (e.style.visibility = "visible", "x" === t ? (n.style.left = c + "px", n.style.width = u + "px") : (n.style.top = c + "px", n.style.height = u + "px")) : e.style.visibility = "hidden"
                }
            }, {
                ...
                key: "recalculate",
                value: function() {
                    this.enabled && (this.resizeScrollContent(), this.resizeScrollbar())
                }
            }, {
                ...
                key: "getElOptions",
                value: function(e) {
                    var n = t.htmlAttributes.reduce(function(t, n) {
                        var r = n[(0, o.default)(n)[0]];
                        return t[(0, o.default)(n)[0]] = !e.hasAttribute(r) || "false" !== e.getAttribute(r), t
                    }, {});
                    return n
                }
            }, {
        ...
        var r = n(5),
            ...
            u = function(t, e, n) {
                var l, a, f, h = t & u.F,
                    ...
                    g = d ? r : p ? r[e] : (r[e] || {})[c];
                d && (n = e);
                for (l in n) a = !h && g && void 0 !== g[l], a && l in m || (f = a ? g[l] : n[l], m[l] = d && "function" != typeof g[l] ? n[l] : y && a ? o(f, r) : b && g[l] == f ? function(t) {
        ...
        t.exports = function(t, e, n, m, x, g, E) {
            l(n, e, m);
            var S, w, O, k = function(t) {
            ...
            if (N && (O = f(N.call(new t)), O !== Object.prototype && (a(O, j, !0), r || c(O, h) || s(O, h, b))), A && M && M.name !== y && (C = !0, L = function() {
                    return M.call(this)
                }), r && !E || !d && !C && _[h] || s(_, h, L), u[e] = L, u[j] = b, x)
                if (S = {
                        values: A ? L : k(y),
                        keys: g ? L : k(v),
                        entries: T
                    }, E)
                    for (w in S) w in _ || o(_, w, S[w]);
                else i(i.P + i.F * (d || C), e, S);
            return S
        }
    }, function(t, e, n) {
        var r = n(2)("iterator"),
        ...
        t.exports = !u || n(8)(function() {
            ...
            for (var n = s(t), u = arguments.length, l = 1, a = i.f, f = o.f; u > l;)
                for (var h, d = c(arguments[l++]), p = a ? r(d).concat(a(d)) : r(d), v = p.length, y = 0; v > y;) f.call(d, h = p[y++]) && (n[h] = d[h]);
            return n
        } : u
    }, function(t, e, n) {
        var r = n(7),
        ...
        i(i.S + i.F * !n(49)(function(t) {
            ...
            from: function(t) {
                var e, n, i, f, h = o(t),
                    ...
                    b = 0,
                    m = a(h);
                if (y && (v = r(v, p > 2 ? arguments[2] : void 0, 2)), void 0 == m || d == Array && c(m))
                    for (e = u(h.length), n = new d(e); e > b; b++) l(n, b, y ? v(h[b], b) : h[b]);
                else
                    for (f = m.call(h), n = new d; !(i = f.next()).done; b++) l(n, b, y ? s(f, v, [i.value, b], !0) : i.value);
                return n.length = b, n
            }
        })
    }, function(t, e, n) {
        ...
        (function(e) {
            function n(t, e, n) {
                function i(e) {
                    var n = v,
                        r = y;
                    return v = y = void 0, O = e, m = t.apply(r, n)
                }

                function o(t) {
                    return O = t, x = setTimeout(a, e), k ? i(t) : m
                }
                ...
                function f(t) {
                    return x = void 0, A && v ? i(t) : (v = y = void 0, m)
                }

                function h() {
                    void 0 !== x && clearTimeout(x), O = 0, v = w = y = x = void 0
                }

                function d() {
                    return void 0 === x ? m : f(S())
                }
                ...
                function p() {
                    ...
                    if (v = arguments, y = this, w = t, n) {
                        if (void 0 === x) return o(w);
                        if (j) return x = setTimeout(a, e), i(w)
                    }
                ...
                return e = s(e) || 0, r(n) && (k = !!n.leading, j = "maxWait" in n, b = j ? g(s(n.maxWait) || 0, e) : b, A = "trailing" in n ? !!n.trailing : A), p.cancel = h, p.flush = d, p
            }
